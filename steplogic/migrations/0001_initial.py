# Generated by Django 3.2.8 on 2021-10-19 22:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='steplogic.env')),
                ('os_version', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='steplogic.operative_system_info')),
                ('server_role_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='steplogic.server_roles')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='env',
            name='site',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='steplogic.sites'),
        ),
        migrations.CreateModel(
            name='Database_info',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('application_patches', models.ManyToManyField(to='steplogic.Application_patches')),
                ('environment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='steplogic.env')),
